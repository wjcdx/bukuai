...
class BukuaiManager {
	...
	*/
	...
	{
		return $this->entry_load('bukuai_node', $entry);
	}

	public function tree_load($entry = array())
	{
		return $this->entry_load('bukuai_tree', $entry);
	}

	public function node_count()
	{
		return $this->entry_count('bukuai_node');
	}

	public function tree_count()
	{
		return $this->entry_count('bukuai_tree');
	}
